...
['cols', 'rows', 'size', 'p'].forEach(function (name) {
...
['rowp', 'start'].forEach(function (name) {
...
function dangerousStyleValue(name, value, isCustomProperty) {
  ...
  // http://www.thepner.co.uk/2007/11/26/ultimate-xss-css-injection/
...
function diffHydratedProperties(domElement, tag, rawProps, parentNamespace, rootContainerElement) {
  ...
  for (var propKey in rawProps) {
    ...
    if (propKey === CHILDREN) {
      ...
      // textContent. E.g. "foo" will match "f<p>oo</p>" but that still
